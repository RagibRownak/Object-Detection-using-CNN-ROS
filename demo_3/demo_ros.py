...
class PanopticSegmentationNode(Node):
    ...
    def publish_static_transforms(self):
        ...
        transform.header.frame_id = "base_link"  # CHANGED: Removed namespace
        ...
        scan_transform.header.frame_id = "base_link"  # CHANGED: Removed namespace
        scan_transform.child_frame_id = "base_scan"   # CHANGED: Removed namespace
    ...
    def publish_laser_scan(self, predictions):
        ...
        try:
            ...
            # This should match exactly what Nav2 expects
            scan_msg.header.frame_id = "base_scan"  # Remove namespace
